	    ...
	    value: function updateCanvas() {
	      ...
	      Game.prototype.doesCollide = function (room) {
	        for (var i = 0; i < this.rooms.length; i++) {
	          ...
	          if (room.x >= room2.x && room.x <= room2.x + room2.width && (room.y >= room2.y && room2.y + room2.height >= room.y || room.y <= room2.y && room.y + room.height >= room2.y) || room.x <= room2.x && room.x + room.width >= room2.x && (room.y >= room2.y && room2.y + room2.height >= room.y || room.y <= room2.y && room.y + room.height >= room2.y)) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { className: "meta" },
	            "Lvl: ",
	            _react2.default.createElement("span", { className: "player-lvl" })
	          ),
	          _react2.default.createElement(
	            "h3",
	            { className: "meta" },
	            "HP: ",
	            _react2.default.createElement("span", { className: "player-hp" })
	          ),
	          _react2.default.createElement(
	            "h3",
	            { className: "meta", id: "enemy" },
	            "Enemy: ",
	            _react2.default.createElement("span", { className: "wraith-hp" })
	          ),
	          _react2.default.createElement(
	            "h3",
	            { className: "meta" },
	            "Attack: ",
	            _react2.default.createElement("span", { className: "player-atk" })
	          ),
	          _react2.default.createElement(
	            "h3",
	            { className: "meta" },
	            "Exp: ",
	            _react2.default.createElement("span", { className: "player-exp" }),
	            _react2.default.createElement(
	              "span",
	              null,
	              "/80"
	          ...
	          _react2.default.createElement(
	            ...
	            { className: "meta" },
	            "Weapon: ",
	            _react2.default.createElement("span", { className: "player-wpn" })
	          ),
	          _react2.default.createElement(
	            "h3",
	            { className: "meta" },
	            "Moria: ",
	            _react2.default.createElement("span", { className: "dungeon-lvl" })
	          )
	        ),

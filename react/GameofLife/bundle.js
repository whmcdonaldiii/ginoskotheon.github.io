...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameboard = __webpack_require__(202);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            'Add or remove cells by clicking on a cell. Lighter cells are new in the current generation, darker cells have survived for at least one generation'
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function (_React$Component) {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "button",
	            { className: "btn btn-default btn-sm", onClick: this.handleRunPause.bind(this) },
	            "Start"
	          ),
	          _react2.default.createElement(
	            "button",
	            { className: "btn btn-default btn-sm", onClick: this.handlePause.bind(this) },
	            "Pause"
	          ),
	          _react2.default.createElement(
	            "button",
	            { className: "btn btn-default btn-sm", onClick: this.handleNext.bind(this) },
	            "One Turn"
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "button",
	            { className: "btn btn-default btn-sm", onClick: this.handleNewBoard.bind(this, 0) },
	            "Clear Board"
	          ),
	          _react2.default.createElement(
	            "button",
	            { className: "btn btn-default btn-sm", onClick: this.handleNewBoard.bind(this, 1) },
	            "New Random Game"
	          )
	        ),
	    ...
	    key: "handleRunPause",
	    value: function handleRunPause(e) {
	      e.preventDefault();
	    ...
	    key: "handleNewBoard",
	    value: function handleNewBoard(createVal, e) {
	    ...
	    value: function render() {
	      ...
	      var rows = gameBoard.map(function (item, i) {
	        var entry = item.map(function (element, j) {
	          return _react2.default.createElement(_cell2.default, { key: j, toggle: that.toggleLife.bind(that), loc: [j, i], info: element, index: j });
	        });
	        return _react2.default.createElement(
	          'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = function (_React$Component) {
	  ...
	  _createClass(Footer, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "button",
	            { className: "btn btn-default", onClick: this.handleSpeed.bind(this, 500) },
	            "Slow"
	          ),
	          _react2.default.createElement(
	            "button",
	            { className: "btn btn-default", onClick: this.handleSpeed.bind(this, 250) },
	            "Medium"
	          ),
	          _react2.default.createElement(
	            "button",
	            { className: "btn btn-default", onClick: this.handleSpeed.bind(this, 120) },
	            "Fast"
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "button",
	            { id: "smallCanvas", className: "btn btn-default", onClick: this.handleSize.bind(this, [50, 30]) },
	            "50 x 30"
	          ),
	          _react2.default.createElement(
	            "button",
	            { id: "mediumCanvas", className: "btn btn-default", onClick: this.handleSize.bind(this, [70, 50]) },
	            "70 x 50"
	          ),
	          _react2.default.createElement(
	            "button",
	            { id: "bigCanvas", className: "btn btn-default", onClick: this.handleSize.bind(this, [100, 80]) },
	            "100 x 80"
	          )
	        )
	      );
	    ...
	    key: "handleSize",
	    value: function handleSize(arr, e) {
	      e.preventDefault();
	      this.props.newBoard(1, arr);
	    }
	  }, {
	    key: "handleSpeed",
	    value: function handleSpeed(num, e) {
	      e.preventDefault();

...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactLocalstorage = __webpack_require__(203);

	var _reactLocalstorage2 = _interopRequireDefault(_reactLocalstorage);

	var _recipe = __webpack_require__(205);
	...
	var actualRecipes;
	if (localStorage.recipeBook) actualRecipes = JSON.parse(localStorage.recipeBook);else actualRecipes = defaultRecipes;
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    key: 'deleteRecipe',
	    value: function deleteRecipe(item) {
	    ...
	    key: 'editRecipe',
	    value: function editRecipe(item, title, ingr) {
	      var recipeBook = this.state.recipeBook;
	      console.log(recipeBook);
	      var item = item - 1;
	      console.log(item);
	    ...
	    value: function handleIngredients() {
	      var ingredients = document.getElementById('ingredients').value;
	      return ingredients;
	    }
	  }, {
	    key: 'handleRecipe',
	    value: function handleRecipe(event) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'well' },
	          _react2.default.createElement(_recipe2.default, { recipes: this.state.recipeBook, 'delete': this.deleteRecipe.bind(this), edit: this.editRecipe.bind(this) })
	        ),
	        _react2.default.createElement(
	          'button',
	          { className: 'btn btn-primary btn-md', 'data-toggle': 'modal', 'data-target': '#myModal' },
	          'Add Recipe'
	        ),
	        _react2.default.createElement(
	          'div',
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('label', { htmlFor: 'title', className: 'control-label' }),
	                    _react2.default.createElement('input', { type: 'text', name: 'title', placeholder: 'Recipe Name', id: 'title', className: 'form-control', onChange: function onChange() {
	                        return _this2.handleTitle(event);
	                      } })
	                  ),
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'form-group' },
	                    _react2.default.createElement('label', { htmlFor: 'ingredients', className: 'control-label' }),
	                    _react2.default.createElement('textarea', { type: 'textarea', label: 'Ingredients', placeholder: 'List Ingredients separated by a Comma', id: 'ingredients', className: 'form-control', onChange: function onChange() {
	                        return _this2.handleIngredients(event);
	                      } })
	                  )
	                )
	              ),
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  { onClick: function onClick() {
	                      return _this2.handleRecipe(event);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var warn = __webpack_require__(204);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recipe_list = __webpack_require__(206);
	...
	var Recipe = function Recipe(props) {
	  ...
	  var Recipes = props.recipes.map(function (recipe, index) {
	    ...
	    return _react2.default.createElement(_recipe_list2.default, { key: index, title: recipe.title, ingredients: recipe.ingredients, number: index + 1, 'delete': props.delete, edit: props.edit });
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RecipeList = function (_Component) {
	  ...
	  function RecipeList(props) {
	    ...
	    return _possibleConstructorReturn(this, (RecipeList.__proto__ || Object.getPrototypeOf(RecipeList)).call(this, props));
	    // console.log(props)
	  }
	  ...
	  _createClass(RecipeList, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { id: "openRecipe", className: "panel-heading" },
	          _react2.default.createElement(
	            "h4",
	            { className: "panel-title" },
	            _react2.default.createElement(
	              "a",
	              { id: "thetitle", "data-toggle": "collapse", href: "#collapse" + this.props.number },
	              this.props.title
	            )
	          )
	        ),
	        _react2.default.createElement(
	          "div",
	          { id: "collapse" + this.props.number, className: "panel-collapse collapse" },
	          _react2.default.createElement("input", { id: "nums" + this.props.number, type: "hidden", value: this.props.number }),
	          _react2.default.createElement(
	            "div",
	            ...
	            _react2.default.createElement(
	              ...
	              this.props.ingredients.map(function (ingredient, ind) {
	                return _react2.default.createElement(
	                  "li",
	                  { className: "list-group-item", key: ind },
	                  ingredient
	                );
	              })
	            ),
	            ...
	            _react2.default.createElement(
	              "button",
	              { className: "btn btn-primary btn-md", "data-toggle": "modal", "data-target": "#myModal" + this.props.number },
	              "Edit Recipe"
	            )
	          ),
	          _react2.default.createElement(
	            "div",
	            { className: "modal fade", id: "myModal" + this.props.number, tabIndex: "-1", role: "dialog", "aria-labelledby": "myModalLabel", "aria-hidden": "true" },
	            _react2.default.createElement(
	              "div",
	              { className: "modal-dialog", role: "document" },
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      ...
	                      { className: "form-group" },
	                      _react2.default.createElement("label", { htmlFor: "title", className: "control-label" }),
	                      _react2.default.createElement("input", { type: "text", name: "title", placeholder: "Recipe Name", id: "title" + this.props.number, className: "form-control", defaultValue: this.props.title })
	                    ),
	                    _react2.default.createElement(
	                      "div",
	                      { className: "form-group" },
	                      _react2.default.createElement("label", { htmlFor: "ingredients", className: "control-label" }),
	                      _react2.default.createElement("textarea", { type: "textarea", label: "Ingredients", placeholder: "List Ingredients separated by a Comma", id: "ingredients" + this.props.number, className: "form-control", defaultValue: this.props.ingredients })
	                    )
	                  )
	                ),
	                _react2.default.createElement(
